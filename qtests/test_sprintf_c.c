...
START_TEST(sprintf_6_c) {
  char str1[100];
  char str2[100];
  char *str3 = "%05c Test %010c Test %0c Test";
  int a = 70;
...
START_TEST(sprintf_8_c) {
  char str1[100];
  char str2[100];
  char *str3 = "% 4c Test % -4c Test % +c Test % -0c Test % -+0c";
  int a = 10;
...
START_TEST(sprintf_21_c) {
  ...
  char *str3 = "%*c %+*c %0*c";
  int a = 1156;
  ck_assert_int_eq(sprintf(str1, str3, 5, a, 5, a, 5, a),
                   s21_sprintf(str2, str3, 5, a, 5, a, 5, a));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST

START_TEST(sprintf_22_c) {
  char str1[100];
  char str2[100];
  char *str3 = "%";
  int a = 1156;
...
Suite *test_sprintf_c(void) {
  ...
  tcase_add_test(tc, sprintf_6_c);  // 6
  ...
  tcase_add_test(tc, sprintf_22_c);
